...
const { mapPlaylistsToModel, mapPlaylistSongsToModel } = require('../../utils')
...
class PlaylistsService {
  ...
  async getPlaylistSongs (playlistId) {
    ...
    const songs = result.rows.map(mapPlaylistSongsToModel)

    const resultMap = result.rows.map(mapPlaylistsToModel)[0]
